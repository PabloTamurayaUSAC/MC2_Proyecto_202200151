...
public class Gui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Grafo Caminos Minimos-202200151"));
    ...
    private int ingresarPeso(){
        String peso = JOptionPane.showInputDialog("Digite la distancia entre los Vértices");
        int intPeso = 0;
        try{
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
        ...
        if(evt.isMetaDown()){
            ...
            if(nodoInicio == null){
                ...
                Enrutar disjktra = new Enrutar(grafo);
    ...
    private void crearNodo(int x, int y){
        Coordenadas c = new Coordenadas(100000,100000, x, y);
            String dato = JOptionPane.showInputDialog("Digite un dato o Nombre para el Vértice");
            if(dato != null){
